...
totalsizes = (130_000_000_000, 240_000_000_000, 400_000_000_000)
...
runcmd = `numactl --physcpubind=24-47 --membind=1 $jl --color=yes --project -e $cmd`
#for totalsize in (130_000_000_000,  240_000_000_000, 400_000_000_000)
for totalsize in Base.tail(totalsizes)
